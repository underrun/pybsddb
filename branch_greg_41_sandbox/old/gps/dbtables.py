...
class bsdTableDb :
    ...
    def ListTableColumns(self, table):
        ...
        if not self.db.has_key(columnlist_key):
            return []
        pickledcolumnlist = DeadlockWrap(self.db.get, columnlist_key)
    ...
    def CreateOrExtendTable(self, table, columns):
        ...
        try:
            ...
            try:
                ...
                oldcolumnlist = pickle.loads(DeadlockWrap(self.db.get, columnlist_key, txn, DB_RMW))
                ...
                if newcolumnlist != oldcolumnlist :
                    ...
                    DeadlockWrap(self.db.delete, columnlist_key, txn)
                    DeadlockWrap(self.db.put, columnlist_key, pickle.dumps(newcolumnlist, 1), txn)
