...
def suite():
    ...
    theSuite.addTest(unittest.makeSuite(DBShelveTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BTreeShelveTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(HashShelveTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(ThreadBTreeShelveTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(ThreadHashShelveTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(EnvBTreeShelveTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(EnvHashShelveTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(EnvThreadBTreeShelveTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(EnvThreadHashShelveTestCase, 'test'))
