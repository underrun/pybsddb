...
def suite():
    ...
    if have_threads:
        theSuite.addTest(unittest.makeSuite(BTreeConcurrentDataStore, 'test'))
        theSuite.addTest(unittest.makeSuite(HashConcurrentDataStore, 'test'))
        theSuite.addTest(unittest.makeSuite(BTreeSimpleThreaded, 'test'))
        theSuite.addTest(unittest.makeSuite(HashSimpleThreaded, 'test'))
        theSuite.addTest(unittest.makeSuite(BTreeThreadedTransactions, 'test'))
        theSuite.addTest(unittest.makeSuite(HashThreadedTransactions, 'test'))
    else:
