...
class VersionTestCase(unittest.TestCase):
    def test00_version(self):
        ...
        if verbose:
            print '-=' * 20
            print 'bsddb3.db.version(): %s' % (info, )
...
class BasicTransactionTestCase(BasicTestCase):
    ...
    def test06_Transactions(self):
        ...
        assert d.get('new rec', txn=txn) == None
        d.put('new rec', 'this is a new record', txn)
        assert d.get('new rec', txn=txn) == 'this is a new record'
        txn.abort()
...
def suite():
    ...
    theSuite.addTest(unittest.makeSuite(VersionTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BasicBTreeTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BasicHashTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BasicBTreeWithThreadFlagTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BasicHashWithThreadFlagTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BasicBTreeWithEnvTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BasicHashWithEnvTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BTreeTransactionTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(HashTransactionTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BTreeRecnoTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BTreeRecnoWithThreadFlagTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BTreeDUPTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(HashDUPTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BTreeDUPWithThreadTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(HashDUPWithThreadTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(BTreeMultiDBTestCase, 'test'))
    theSuite.addTest(unittest.makeSuite(HashMultiDBTestCase, 'test'))
